...
import { generateStatisticsPdf } from '@/lib/pdf-ticket'
...
export default function StatisticsPage() {
  ...
  function exportPdf() {
    if (weighings.length === 0) {
      toast(lang === 'da' ? 'Ingen data at eksportere' : 'No data to export', 'error')
      return
    }
    generateStatisticsPdf(weighings, dateFrom, dateTo, lang)
    toast(t.statistics.exportPdf)
  }
